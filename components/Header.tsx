    ...
    <header className="container flex flex-col gap-4 bg-foreground p-8 text-background md:flex-row md:items-center md:gap-0">
      ...
      <div className="w-80 md:ml-auto">
        <p className="text-xs">
          ...
          From heart-pounding beats to soul-stirring melodies, each event has
          been a memorable chapter in my musical journey, filled with
          unforgettable moments and euphoric experiences.
        </p>
      </div>
    </header>
  );
